...
sayHelloButton.addEventListener('mouseover' , function btnColor () {
...
//     sayHelloButton.style.color = 'white';
// }
// // ~~~ This block would make the button black immediately on refresh, not on mouseover so i nested the function into the event listener and it worked as intended
...
sayHelloButton.addEventListener('mouseout' , function btnColor2 () {
